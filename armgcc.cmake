...
IF(NOT TOOLCHAIN_DIR OR NOT EXISTS "${TOOLCHAIN_DIR}")
    IF(DEFINED ENV{USERPROFILE} AND EXISTS "$ENV{USERPROFILE}/.mcuxpressotools/arm-gnu-toolchain-14.2.rel1-mingw-w64-x86_64-arm-none-eabi")
        SET(TOOLCHAIN_DIR "$ENV{USERPROFILE}/.mcuxpressotools/arm-gnu-toolchain-14.2.rel1-mingw-w64-x86_64-arm-none-eabi")
        STRING(REGEX REPLACE "\\\\" "/" TOOLCHAIN_DIR "${TOOLCHAIN_DIR}")
    ELSE()
